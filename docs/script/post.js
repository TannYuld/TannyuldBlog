...
function whenBlogPostsChange() {
  ...
  const selectedPost = getBlogs()[id];
  ...
  if (selectedPost.tags) {
    document.getElementById("post-tags").textContent = selectedPost.tags.join(", ");
  }
  document.getElementsByTagName("article")[0].innerHTML = selectedPost.content;
}
